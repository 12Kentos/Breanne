...
export default function Home() {
  ...
  const contentForEndorsment = [
    ...
    <div className={styles.endorsedByContentWrapper}>
      <p className={styles.endorsedText}>
        "We support Breanne for Wasatch County School Board. She has a passion
        for education! She has the knowledge, experience, and drive to help take
        our school district to the next level. Wasatch County School District is
        doing great things, and we believe she can build on that success."
        <span className={styles.author}>- Blaine & Shantel Rigby</span>
      </p>
      <Image
        src={rigby}
        className={`${styles.endorsedPic} ${styles.tallerPic}`}
  ...
  return (
    <main className={styles.mainWrapper}>
      ...
      <div className={styles.endorsedByWrapper}>
        <h2 className={styles.endorsedByHeader}>endorsements</h2>
